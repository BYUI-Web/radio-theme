...
<meta name="google-site-verification" content="l8dnLSWqpxlheDYDv9B0fFIYjX7309HWMUA_VqoniZM" />
  ...
  <!-- XML Parsing -->
  <script type="text/javascript" src="<?php bloginfo('template_url'); ?>/js/xml.js"></script>

  <!-- EMERGENCY FEED Parsing ASYNC INCLUDE
-->
<script type="text/javascript">
  // (function(d, t) {
  //   var g = d.createElement(t),
  //   s = d.getElementsByTagName(t)[0];
  //   g.src = '<?php bloginfo('template_url'); ?>/js/emergency.min.js';
...
<main role="main">
  <div class="container content-wrap">
   ...
   <div class="header-logo">
    <img src="<?php bloginfo('template_url') ?>/images/byui-radio-logo-final.png" />
  </div>
  <!--*************************************************************-->
  <!-- Bootstrap Nav Bar defaults to bootstrap standard menu style -->
  <!--      If you want to edit add additional classes to the nav  -->
  <!--*************************************************************-->
